import{s as X,a as A,k as F,m as B,e as h,p as c,b as u,q as m,t as f,i as o,w as D,f as s}from"../chunks/scheduler.75f5293f.js";import{S as G,i as M,c as N,b as R,m as U,t as J,a as K,d as V}from"../chunks/index.36074062.js";import{g as Y,a as Z}from"../chunks/spread.8a54911c.js";import{P as tt}from"../chunks/Post.19bcd7ab.js";function et(C){let e,p=`One evening, when I was working on a large customer data store, there was an emergency team
		...
		he didn't give me any opportunity.`,I,y,L=`Finally he finished. I let the room know that we had run the script and it completed in under 15
		...
		Don't be that (random) guy.`;return{c(){e=h("p"),e.textContent=p,i=c(),l=h("p"),l.textContent=n,r=c(),d=h("p"),d.textContent=W,k=c(),w=h("p"),w.textContent=j,P=c(),g=h("p"),g.textContent=q,$=c(),v=h("p"),v.textContent=z,I=c(),y=h("p"),y.textContent=L,S=c(),_=h("p"),_.textContent=O,H=c(),x=h("p"),x.textContent=Q,T=c(),b=h("p"),b.textContent=E},l(t){e=u(t,"P",{"data-svelte-h":!0}),m(e)!=="svelte-zi2g9c"&&(e.textContent=p),i=f(t),l=u(t,"P",{"data-svelte-h":!0}),m(l)!=="svelte-139gv2o"&&(l.textContent=n),r=f(t),d=u(t,"P",{"data-svelte-h":!0}),m(d)!=="svelte-1qkpabd"&&(d.textContent=W),k=f(t),w=u(t,"P",{"data-svelte-h":!0}),m(w)!=="svelte-11ih7t0"&&(w.textContent=j),P=f(t),g=u(t,"P",{"data-svelte-h":!0}),m(g)!=="svelte-o6jwum"&&(g.textContent=q),$=f(t),v=u(t,"P",{"data-svelte-h":!0}),m(v)!=="svelte-9eoe3a"&&(v.textContent=z),I=f(t),y=u(t,"P",{"data-svelte-h":!0}),m(y)!=="svelte-jti4uy"&&(y.textContent=L),S=f(t),_=u(t,"P",{"data-svelte-h":!0}),m(_)!=="svelte-kf8eoq"&&(_.textContent=O),H=f(t),x=u(t,"P",{"data-svelte-h":!0}),m(x)!=="svelte-1k14eib"&&(x.textContent=Q),T=f(t),b=u(t,"P",{"data-svelte-h":!0}),m(b)!=="svelte-16dmrzs"&&(b.textContent=E)},m(t,a){o(t,e,a),o(t,i,a),o(t,l,a),o(t,r,a),o(t,d,a),o(t,k,a),o(t,w,a),o(t,P,a),o(t,g,a),o(t,$,a),o(t,v,a),o(t,I,a),o(t,y,a),o(t,S,a),o(t,_,a),o(t,H,a),o(t,x,a),o(t,T,a),o(t,b,a)},p:D,d(t){t&&(s(e),s(i),s(l),s(r),s(d),s(k),s(w),s(P),s(g),s($),s(v),s(I),s(y),s(S),s(_),s(H),s(x),s(T),s(b))}}}function nt(C){let e,p;const i=[{category:"Story"},{headline:"Speed Estimation"},{postUrl:"speed-estimation"},C[0]];let l={$$slots:{default:[et]},$$scope:{ctx:C}};for(let n=0;n<i.length;n+=1)l=A(l,i[n]);return e=new tt({props:l}),{c(){N(e.$$.fragment)},l(n){R(e.$$.fragment,n)},m(n,r){U(e,n,r),p=!0},p(n,[r]){const d=r&1?Y(i,[i[0],i[1],i[2],Z(n[0])]):{};r&2&&(d.$$scope={dirty:r,ctx:n}),e.$set(d)},i(n){p||(J(e.$$.fragment,n),p=!0)},o(n){K(e.$$.fragment,n),p=!1},d(n){V(e,n)}}}function at(C,e,p){const i=[];let l=F(e,i);return C.$$set=n=>{e=A(A({},e),B(n)),p(0,l=F(e,i))},[l]}class rt extends G{constructor(e){super(),M(this,e,at,nt,X,{})}}export{rt as component};
