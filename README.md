# <i class="fa fa-github"/> Recoil JS examples
...
# <i class="fa fa-people-carry"/> 3 tenets for leading software development teams
...
# <i class="fa fa-file-code"/> How to name things in code
...
# <i class="fas fa-map-marked-alt"/> Organize code using the principle of locality
