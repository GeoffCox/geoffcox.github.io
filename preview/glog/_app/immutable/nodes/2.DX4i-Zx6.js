import{a as I,t as O,g as Le,k as pe}from"../chunks/disclose-version.uDeAePpO.js";import{C as qe,d as Je,h as X,g as ue,b as Ye,V as Ve,A as Re,H as Xe,e as ye,i as he,m as oe,aq as re,j as Pe,k as De,l as Qe,D as ke,ar as Se,as as Ze,z as $e,at as et,ah as tt,o as ot,w as nt,am as it,a3 as at,M as Ie,au as we,av as be,aw as st,u as rt,ax as Ge,a6 as lt,ay as ct,t as ne,a as ae,az as ie,s as E,c as G,r as D,p as se,ae as J,O as T,Q as l,I as xe,f as B,a4 as Q,aA as He,af as ee,aj as dt}from"../chunks/runtime.Dw9PevHv.js";import{o as ce}from"../chunks/index-client.BJqJXq_0.js";import{i as R}from"../chunks/if.Cm640iHB.js";import{r as _t,p as z,a as ge}from"../chunks/props.DnjauSsg.js";import{s as le}from"../chunks/render.C95QHNkD.js";import{s as ut,g as Fe,a as ht}from"../chunks/settings.svelte.hrrQ3M3V.js";import{r as Oe}from"../chunks/entry.C7u7pX68.js";import{p as Te}from"../chunks/index.DD0WeZVE.js";function Ee(a,e){return e}function mt(a,e,n,o){for(var c=[],f=e.length,s=0;s<f;s++)Ze(e[s].e,c,!0);var b=f>0&&c.length===0&&n!==null;if(b){var y=n.parentNode;$e(y),y.append(n),o.clear(),q(a,e[0].prev,e[f-1].next)}et(c,()=>{for(var u=0;u<f;u++){var g=e[u];b||(o.delete(g.k),q(a,g.prev,g.next)),tt(g.e,!b)}})}function fe(a,e,n,o,c,f=null){var s=a,b={flags:e,items:new Map,first:null},y=(e&Ge)!==0;if(y){var u=a;s=X?ue(ot(u)):u.appendChild(qe())}X&&Ye();var g=null,S=!1;Je(()=>{var w=n(),d=Ve(w)?w:w==null?[]:Re(w),r=d.length;if(S&&r===0)return;S=r===0;let m=!1;if(X){var C=s.data===Xe;C!==(r===0)&&(s=ye(),ue(s),he(!1),m=!0)}if(X){for(var k=null,i,t=0;t<r;t++){if(oe.nodeType===8&&oe.data===nt){s=oe,m=!0,he(!1);break}var p=d[t],_=o(p,t);i=je(oe,b,k,null,p,_,t,c,e),b.items.set(_,i),k=i}r>0&&ue(ye())}if(!X){var v=it;pt(d,b,s,c,e,(v.f&re)!==0,o)}f!==null&&(r===0?g?Pe(g):g=De(()=>f(s)):g!==null&&Qe(g,()=>{g=null})),m&&he(!0),n()}),X&&(s=oe)}function pt(a,e,n,o,c,f,s,b){var N,L,F,Z;var y=(c&ct)!==0,u=(c&(be|we))!==0,g=a.length,S=e.items,w=e.first,d=w,r,m=null,C,k=[],i=[],t,p,_,v;if(y)for(v=0;v<g;v+=1)t=a[v],p=s(t,v),_=S.get(p),_!==void 0&&((N=_.a)==null||N.measure(),(C??(C=new Set)).add(_));for(v=0;v<g;v+=1){if(t=a[v],p=s(t,v),_=S.get(p),_===void 0){var Y=d?d.e.nodes_start:n;m=je(Y,e,m,m===null?e.first:m.next,t,p,v,o,c),S.set(p,m),k=[],i=[],d=m.next;continue}if(u&&gt(_,t,v,c),_.e.f&re&&(Pe(_.e),y&&((L=_.a)==null||L.unfix(),(C??(C=new Set)).delete(_))),_!==d){if(r!==void 0&&r.has(_)){if(k.length<i.length){var M=i[0],h;m=M.prev;var x=k[0],U=k[k.length-1];for(h=0;h<k.length;h+=1)Ce(k[h],M,n);for(h=0;h<i.length;h+=1)r.delete(i[h]);q(e,x.prev,U.next),q(e,m,x),q(e,U,M),d=M,m=U,v-=1,k=[],i=[]}else r.delete(_),Ce(_,d,n),q(e,_.prev,_.next),q(e,_,m===null?e.first:m.next),q(e,m,_),m=_;continue}for(k=[],i=[];d!==null&&d.k!==p;)(f||!(d.e.f&re))&&(r??(r=new Set)).add(d),i.push(d),d=d.next;if(d===null)continue;_=d}k.push(_),m=_,d=_.next}if(d!==null||r!==void 0){for(var H=r===void 0?[]:Re(r);d!==null;)(f||!(d.e.f&re))&&H.push(d),d=d.next;var P=H.length;if(P>0){var K=c&Ge&&g===0?n:null;if(y){for(v=0;v<P;v+=1)(F=H[v].a)==null||F.measure();for(v=0;v<P;v+=1)(Z=H[v].a)==null||Z.fix()}mt(e,H,K,S)}}y&&lt(()=>{var j;if(C!==void 0)for(_ of C)(j=_.a)==null||j.apply()}),ke.first=e.first&&e.first.e,ke.last=m&&m.e}function gt(a,e,n,o){o&be&&Se(a.v,e),o&we?Se(a.i,n):a.i=n}function je(a,e,n,o,c,f,s,b,y,u){var g=(y&be)!==0,S=(y&st)===0,w=g?S?at(c):Ie(c):c,d=y&we?Ie(s):s,r={i:d,v:w,k:f,a:null,e:null,prev:n,next:o};try{return r.e=De(()=>b(a,w,d),X),r.e.prev=n&&n.e,r.e.next=o&&o.e,n===null?e.first=r:(n.next=r,n.e.next=r.e),o!==null&&(o.prev=r,o.e.prev=r.e),r}finally{}}function Ce(a,e,n){for(var o=a.next?a.next.e.nodes_start:n,c=e?e.e.nodes_start:n,f=a.e.nodes_start;f!==o;){var s=rt(f);c.before(f),f=s}}function q(a,e,n){e===null?a.first=n:(e.next=n,e.e.next=n&&n.e),n!==null&&(n.prev=e,n.e.prev=e&&e.e)}const ft=!0,vn=Object.freeze(Object.defineProperty({__proto__:null,prerender:ft},Symbol.toStringTag,{value:"Module"}));var vt=O('<div>&gt; <span class="cursor svelte-44s095">█</span></div>');function ze(a,e){let n=_t(e,["$$slots","$$events","$$legacy"]);var o=vt();let c;ne(()=>c=ut(o,c,{class:"prompt-indicator",...n},"svelte-44s095")),I(a,o)}var wt=(a,e)=>e(" "),bt=(a,e)=>e("Escape"),yt=O('<div class="more-prompt svelte-18s4q0e">-- more -- <!> <div class="commands"><button class="choice svelte-18s4q0e">[space] to continue</button> <span>|</span> <button class="choice svelte-18s4q0e">[esc] to skip</button></div></div>');function kt(a,e){ae(e,!0),ie("stepContext");const n=async u=>{u===" "||u===" "?e.onContinue():u==="Escape"&&e.onSkip()},o=u=>{u.getModifierState,!u.metaKey&&!u.altKey&&!u.ctrlKey&&n(u.key)};ce(()=>(window.addEventListener("keydown",o),()=>{window.removeEventListener("keydown",o)}));var c=yt(),f=E(G(c));ze(f,{});var s=E(f,2),b=G(s);b.__click=[wt,n];var y=E(b,4);y.__click=[bt,n],D(s),D(c),I(a,c),se()}Le(["click"]);var St=O("<pre> </pre> <!>",1);function ve(a,e){ae(e,!0);const n=ie("stepContext"),o=ie("screenContext"),c=h=>new Promise(x=>setTimeout(x,h)),f=h=>{if(typeof h=="string")return h;if(typeof h=="function")return h();throw new Error("Invalid message type")};let s=Q(()=>f(e.message)),b=J(z([])),y=Q(()=>l(b).join("")),u=J(!e.spool);T(b,z(e.spool?[]:[l(s)]));let g=J(0),S=J(!1),w;const d=async()=>(T(S,!0),await ee(),n.onNewLine(),new Promise(h=>{w=h})),r=()=>{T(S,!1),w==null||w(!0),w=void 0},m=()=>{T(S,!1),w==null||w(!1),w=void 0,T(u,!0)},C=3,k=async()=>{const h=l(s).length>1e3?4:2;for(let x=0;x<l(s).length;x++)if(l(u)){T(b,z([l(s)]));break}else x%h===0&&await c(0),l(b).push(l(s)[x]),l(s)[x]===`
`&&(n.onNewLine(),He(g),o.linesPerScreen&&l(g)>=o.linesPerScreen-C&&(await d(),T(g,0)));n.onNewLine(),T(u,!0)};let i=l(s);xe(()=>{e.spool&&l(s)!==void 0&&l(s)!==i&&l(u)&&(i=l(s),T(b,z(e.spool?[]:[l(s)])),T(u,!e.spool),e.spool&&k())}),xe(()=>{var h;e.spool&&l(u)&&((h=e.onSpooled)==null||h.call(e))});const t=h=>{!h.metaKey&&!h.altKey&&!h.ctrlKey&&!l(S)&&h.key==="Escape"&&T(u,!0)};ce(()=>(e.spool&&k(),window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}));var p=St(),_=B(p),v=G(_,!0);D(_);var Y=E(_,2);{var M=h=>{kt(h,{onContinue:r,onSkip:m})};R(Y,h=>{l(S)&&h(M)})}ne(()=>le(v,l(y))),I(a,p),se()}var It=O("<br> <!> <div> </div>",1),xt=O('<button class="choice svelte-12ctzjl"><!></button>'),Ot=(a,e)=>e("B"),Tt=O('<button class="choice svelte-12ctzjl">[B]ack</button>'),Et=O("<span>|</span>"),Ct=(a,e)=>e("M"),Mt=O('<button class="choice svelte-12ctzjl">[M]ain Menu</button>'),At=O('<br> <!> <div class="commands"><!> <!> <!></div>',1),Nt=O("<!> <!>",1),Lt=O('<div class="choice svelte-12ctzjl"> </div>'),Rt=O("<!> <div> </div>",1),Pt=O('<div class="choices svelte-12ctzjl"><!> <!></div>');function Dt(a,e){ae(e,!0);const n=ie("stepContext");let o=ge(e,"menuItems",19,()=>[]),c=ge(e,"userChoice",15),f=J(z(!e.menuTitle||!e.spool)),s=J(z(e.spool?o().length:0));const b=t=>{switch(t.kind){case"url":n.goToUrl(t.link);break;case"step":n.goToStep(t.link);break;case"action":n.takeAction(t.link);break}},y=t=>{if(c()===void 0){const p=o()[t];p&&(c(`${t+1}`),b(p))}},u=async t=>{if(c()===void 0)if(n.canGoBack&&(t==="b"||t==="B"))c("B"),n.goBack();else if(n.canGoToMainMenu&&(t==="m"||t==="M"))c("M"),n.goToStep("main-menu");else{const p=Number.parseInt(t);p!=null&&p!==Number.NaN&&y(p-1)}},g=t=>{t.getModifierState,!t.metaKey&&!t.altKey&&!t.ctrlKey&&u(t.key)};ce(()=>(window.addEventListener("keydown",g),()=>{window.removeEventListener("keydown",g)}));const S=()=>{T(f,!0)},w=()=>{var t;He(s),l(s)>=o().length&&((t=e.onSpooled)==null||t.call(e)),n.onNewLine()},d=(t,p)=>{const _=typeof t.text=="function"?t.text():t.text;switch(t.kind){case"url":return`${p+1}. ${_} [↗]`;case"step":case"action":return`${p+1}. ${_}`}};var r=Pt(),m=G(r);{var C=t=>{var p=It(),_=E(B(p),2);ve(_,{get message(){return e.menuTitle},spool:!0,onSpooled:S});var v=E(_,2),Y=G(v,!0);ne(()=>le(Y,"-".repeat(e.menuTitle.length))),D(v),I(t,p)};R(m,t=>{e.menuTitle&&t(C)})}var k=E(m,2);{var i=t=>{var p=pe(),_=B(p);{var v=M=>{var h=Nt(),x=B(h);fe(x,17,o,Ee,(P,K,N)=>{var L=pe(),F=B(L);{var Z=j=>{var $=xt();$.__click=()=>y(N);var de=G($),_e=Q(()=>d(l(K),N)),A=Q(()=>e.spool&&l(s)===N);ve(de,{get message(){return l(_e)},get spool(){return l(A)},onSpooled:w}),D($),I(j,$)};R(F,j=>{(!e.spool||N<=l(s))&&j(Z)})}I(P,L)});var U=E(x,2);{var H=P=>{var K=At(),N=E(B(K),2);ze(N,{});var L=E(N,2),F=G(L);{var Z=A=>{var V=Tt();V.__click=[Ot,u],I(A,V)};R(F,A=>{n.canGoBack&&A(Z)})}var j=E(F,2);{var $=A=>{var V=Et();I(A,V)};R(j,A=>{n.canGoBack&&n.canGoToMainMenu&&A($)})}var de=E(j,2);{var _e=A=>{var V=Mt();V.__click=[Ct,u],I(A,V)};R(de,A=>{n.canGoToMainMenu&&A(_e)})}D(L),I(P,K)};R(U,P=>{l(s)>=o().length&&P(H)})}I(M,h)},Y=M=>{var h=Rt(),x=B(h);fe(x,17,o,Ee,(P,K,N)=>{var L=Lt(),F=G(L,!0);ne(()=>le(F,d(l(K),N))),D(L),I(P,L)});var U=E(x,2),H=G(U);D(U),ne(()=>le(H,`> ${c()??""}`)),I(M,h)};R(_,M=>{c()===void 0?M(v):M(Y,!1)})}I(t,p)};R(k,t=>{l(f)&&t(i)})}D(r),I(a,r),se()}Le(["click"]);var Gt=O("<div><!> <!></div>");function Ht(a,e){ae(e,!0);const n=ie("stepContext");let o=ge(e,"step",7),c=J(z(!o().message||o().displayed)),f=J(z(!o().menuItems||o().menuItems.length===0||o().displayed));const s=r=>new Promise(m=>setTimeout(m,r)),b=async()=>{o().holdMs&&await s(o().holdMs),T(c,!0),o().autoNextStepId&&(o().displayed=!0,n.goToStep(o().autoNextStepId))},y=async()=>{T(f,!0),o().displayed=!0};var u=Gt(),g=G(u);{var S=r=>{var m=Q(()=>!l(c));ve(r,{get message(){return o().message},get spool(){return l(m)},onSpooled:b})};R(g,r=>{o().message&&r(S)})}var w=E(g,2);{var d=r=>{var m=pe(),C=B(m);{var k=i=>{var t=Q(()=>!l(f));Dt(i,{get menuTitle(){return o().menuTitle},get menuItems(){return o().menuItems},get spool(){return l(t)},onSpooled:y,get userChoice(){return o().userChoice},set userChoice(p){o().userChoice=p}})};R(C,i=>{o().autoNextStepId||i(k)})}I(r,m)};R(w,r=>{l(c)&&r(d)})}D(u),I(a,u),se()}const Ft=`
...
`,Zt=[Me,Ft,jt,zt,Ut,Kt,Wt,Me,Bt,qt,Jt,Yt,Vt,Xt,Qt],$t=`

            | Talented Developer | Thoughtful Leader | Kind Person |            
`,eo=`
================================================================================`,to="================================================================================",oo=()=>eo+Zt[14]+to+$t,no={id:"banner",message:oo,autoNextStepId:"news"},io=`
--------------------------------------------------------------------------------
binary-search
--------------------------------------------------------------------------------
 ...
 OO:::::::::::::OO                         o:::::::::::::::o
   OO:::::::::OO                            oo:::::::::::oo 
     OOOOOOOOO                                ooooooooooo   
            ...
            This section still under construction.</pre>`,To={id:"under-construction",message:Oo},Ue={id:"main-menu",menuTitle:"MAIN MENU",menuItems:[{kind:"step",text:"Experience",link:"experience"},{kind:"step",text:"Skills",link:"skills"},{kind:"step",text:"Accomplishments",link:"accomplishments"},{kind:"step",text:"Projects",link:"projects"},{kind:"step",text:"Contact Me",link:"contact"},{kind:"step",text:"Curations",link:"curations"},{kind:"url",text:"Paper Resume",link:"https://geoffcox.github.io/geoffcoxresume.pdf"}]},Eo=`
--------------------------------------------------------------------------------
NEWS
--------------------------------------------------------------------------------
